...
decisions = ''' 
    ...
    decision build_tourist_spots_dec(n->aviable_economic_resources >= extension/5000, build_tourist_spots)<< n >>;
    ...
    decision social_investments_dec(n->aviable_economic_resources >= n->population/5000, social_investments)<< n >>;
