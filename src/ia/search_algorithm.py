...
def bfsearch(domain, initial_state, goal_state, heuristic):
    ...
    while not queue.empty():
        ...
        if state not in visited:
            ...
            for next_state in next(domain, state, goal_state, h_values):                
                queue.push()
...
def next(domain, state, goal_state, h_values):
